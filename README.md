...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/603e595528c5000016d4e1e8
...
To start editing your site, you can use the Sanity interface at https://festive-apple-e5955.sanity.studio/.
...
Generated at `2021-03-02T15:27:43.294Z` by Stackbit version `0.3.50`.